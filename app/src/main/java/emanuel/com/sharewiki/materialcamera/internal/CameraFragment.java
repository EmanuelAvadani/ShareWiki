...
import emanuel.com.sharewiki.materialcamera.util.Degrees;
import emanuel.com.sharewiki.materialcamera.util.ImageUtil;
import emanuel.com.sharewiki.materialcamera.util.ManufacturerUtil;

import static emanuel.com.sharewiki.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static emanuel.com.sharewiki.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static emanuel.com.sharewiki.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static emanuel.com.sharewiki.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static emanuel.com.sharewiki.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static emanuel.com.sharewiki.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  emanuel.com.sharewiki.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new emanuel.com.sharewiki.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof emanuel.com.sharewiki.materialcamera.internal.CameraPreview)
