...
import emanuel.com.sharewiki.easyvideoplayer.EasyVideoCallback;
import emanuel.com.sharewiki.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(emanuel.com.sharewiki.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(emanuel.com.sharewiki.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(emanuel.com.sharewiki.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
